...
- [ ] R-BUN `dev.ps1 build` 的 `--services` 白名单是维护热点:R4/R7/R8 新增 trace/admin/metrics 服务时必须同步补名字,漏补表现为该服务端点静默 404。考虑在 R9 冒烟里加一条「已声明服务全部可达」的断言 (2026-08-29;R5 已补入 notes,该条仍未消)
