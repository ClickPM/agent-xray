...
### R-CARDS — 会话区信息卡片:内容级 `xray-card` 围栏块 + 声明式交互(命名轮;所有者裁定 2026-09-08;设计稿 2026-09-09 已并入、开工中)
...
> 同一顺序、**不是**规则 8 的例外:桌面 `2s` / `2t` 放新文件 `Agent X-Ray Cards.dc.html`,移动 `4y` / `4z` 追加;并入 `design/` 之后才开工 —— **设计稿已于 2026-09-09 并入**(四项判据全过,见 `design/README.md` 增删记录),分支 `round-cards` 开工中。
